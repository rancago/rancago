// rancago-server is the HTTP + gRPC server entry point for the Rancago Framework.
// For code generation and project scaffolding, use the standalone rancago-cli:
//
...
`)
	...
	app := bootstrap.New()
	log.Println("[rancago] Bootstrapping application...")
	app.RegisterCore()
	app.Boot()
